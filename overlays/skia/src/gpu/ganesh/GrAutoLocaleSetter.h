...
#if !defined(__MINGW32__) && (defined(SK_BUILD_FOR_MAC) || defined(SK_BUILD_FOR_IOS))
#include <xlocale.h>
#include <cstring>
...
#if defined(__MINGW32__) || defined(SK_BUILD_FOR_ANDROID) || defined(__UCLIBC__) || defined(_NEWLIB_VERSION)
