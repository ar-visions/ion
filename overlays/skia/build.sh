...
is_official_build=false is_debug=false is_component_build=false is_trivial_abi=true werror=true 
...
skia_use_zlib=false skia_enable_ganesh=false skia_enable_sksl=false skia_build_for_debugger=false 
